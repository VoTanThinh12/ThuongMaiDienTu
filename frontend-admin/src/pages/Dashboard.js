          ...
          <Row gutter={[24, 24]} style={{ marginBottom: 32 }}>
            ...
            <Col xs={24} lg={12}>
              <Card 
                ...
                bodyStyle={{ padding: '16px', height: '140px', overflow: 'hidden' }}
              >
                      ...
                      <List.Item style={{ padding: '8px 0', border: 'none' }}>
                        <div style={{ display: 'flex', alignItems: 'center', gap: 12, width: '100%' }}>
                          <Avatar 
                            ...
                            style={{ 
                              backgroundColor: item.type === 'sale' ? '#f6ffed' : '#e6f7ff',
                              border: item.type === 'sale' ? '1px solid #b7eb8f' : '1px solid #91d5ff'
                            }}
                          />
                          <div style={{ flex: 1, minWidth: 0 }}>
